...
<nav>
	...
	<div class="nav-wrapper">
		...
		<ul ng-show="navigating"  class="left wow fadeIn nav-wrapper">
			...
			<li style="width: 120px;"><a href="" onclick="window.history.back();"> <i class="mdi-navigation-chevron-left left">
			</i><span>@lang('site.seo_countries_nav_comeback')</span></a></li>
			...
			<div class="container">
				...
				<table class="highlight left">
					...
					<tbody>
						...
						<tr>
							<td><a class="item-seo" href="ciudad/{{$c->nombre_ciudad}}/servicio">{{$c->nombre_ciudad}}</a></td>
						</tr>
						@endforeach
