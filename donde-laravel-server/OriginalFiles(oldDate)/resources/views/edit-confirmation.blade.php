...
@section('content')
<div ng-app="myApp">
  <div class="home" ng-controller="editConfirmationController">
  <div class="section search search-form row">
      <div class="row">
          <div class="col s12">
              <div class="row">
                <h3>Su edición a sido completada con exito.</h3>
...
@section('js')
  ...
  {!!Html::script('scripts/panel/controllers/edit-confirm/controller.js')!!}
@stop
