	...
	<div class="home new-home" ng-controller="formController">
		...
		<div class="row">
			...
			<div class="col s12 m6 center-align  ">
				<a href='https://www.huesped.org.ar/' target="_blank">
					<img src="images/logo_huesped.png" width="40%" alt="logo" />
				</a>
			</div>
			<br />
			<br />
		...
		<div class="row">
			...
			<div class="col s12 m6 left-align">
				...
				<p>Ante cualquier consulta, podés comunicarte con Fundación Huésped a <a href="mailto:donde@huesped.org.ar"> donde@huesped.org.ar</a>
				</p>
			</div>
		</div>
	</div>
