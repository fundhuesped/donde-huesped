<div id="dashboard" class="col s12">
  ...
  <div class="section navigate row" ng-cloak ng-hide="loadingDashboard">
    ...
    <h1>
      <span translate="panel_dash_table_title_2"></span>
      ([[nonGeo.length]] ciudades)
      <a target="_self" href="api/v1panelplaces/exportnongeofilterbyuser" ng-click="" class="waves-effect waves-light btn-floating red"><i class="mdi-file-file-download left"></i>
      </a>
    </h1>
    <table class="bordered striped responsive-table">
      <thead>
    ...
    <h1>
      <span translate="panel_dash_table_title_3"></span>
      ([[badGeo.length]] ciudades)
      <a target="_self" href="api/v1panelplaces/exportbadgeofilterbyuser" ng-click="" class="waves-effect waves-light btn-floating red"><i class="mdi-file-file-download left"></i>
      </a>
    </h1>
    <table class="bordered striped responsive-table">
      <thead>
