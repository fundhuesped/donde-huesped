     ...
     <tbody>
      <tr ng-cloak ng-hide="loadingPost" ng-repeat="place in places">
        ...
        <td class="services2">
          ...
          <img ng-show="place.condones" alt="Este lugar distribuye condones" src="images/preservativos.png">
          ...
          <img ng-show="place.ile" alt="Este lugar cuenta con centro de Interrupcion Legal del Embarazo" src="images/ile.png" >
