...
<div id="modal" class="modal modal-fixed-footer">
	...
	<h3 class="newMenuAbout" id="donde"> Sobre #Dónde </h3>
		...
		<p>De forma rápida y sencilla podés encontrar lugares que brindan los siguientes servicios y acceder a más información sobre cada tema:
				...
				<li class="newAboutDefault">Información sobre aborto seguro y realización de interrupción del embarazo </li>
		...
		<p>
				...
				<div class="col s12 m4 center-align newAboutLiMargin">
					<a class="btn-floating btn-large share-buttons" socialshare="" socialshare-provider="twitter" socialshare-text="Encontrá los servicios de salud sexual y reproductiva más cercanos http://donde.huesped.org.ar vía @fundhuesped" socialshare-url="https://donde.huesped.org.ar">
					    <i class="fa fa-twitter"></i>
    				</a>
				</div>

				<div class="col s12 m4 center-align newAboutLiMargin">
					<a class="btn-floating btn-large share-buttons" socialshare="" socialshare-provider="facebook" socialshare-text="Encontrá los servicios de salud sexual y reproductiva más cercanos http://donde.huesped.org.ar vía @fundhuesped" socialshare-url="https://donde.huesped.org.ar">
