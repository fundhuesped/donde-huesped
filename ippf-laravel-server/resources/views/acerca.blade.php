		...
		<p>
			<div class="row">
				<div class="col s12 m12 center-align">
					<a href="https://github.com/njaume/DONDE" target="_blank" rel="external" class="ui-link" translate="about_href_goto_git">
	...
	-->
		<p><b translate="about_title_follow"></b>
			...
			<p><b translate="about_title_visit_page"></b>
				...
				<p><span translate="about_descripcion1_add_info"></span><a href="https://ippf-staging.com.ar/form" rel="external" target="_blank" class="ui-link" translate="about_description2_add_info"></a> <span translate="about_description3_add_info"></span><img class="newAboutIcon+" src="images/about/+btn.png" title="IPPF">   <span translate="about_description4_add_info"></span>
					<span translate="about_description5_add_info"></span><a href="mailto:vamoslacapp@gmail.com" rel="external" target="_blank" class="ui-link">vamoslacapp@gmail.com</a>
				</p>
...
<!--
	...
	<p>Nuestro abordaje integral incluye el desarrollo de investigaciones y soluciones prácticas vinculadas a las políticas de salud pública en nuestro país y en la región. También realizamos acciones masivas de comunicación y prevención innovadoras y de alto impacto a través de una constante presencia en medios de comunicación y redes sociales.</p>
			...
			<p>Los sitios incluidos en #Dónde se obtuvieron gracias a la colaboración de diferentes organismos y a través de pedidos de información.</a> Como #Dónde es una plataforma colaborativa, los datos se amplían y mejoran con los aportes de cada usuari@.</p>
