...
.controller('paisListController', function($scope, $rootScope, $http, $interpolate, $translate) {
  ...
  $scope.loadPage = function(){
    ...
    $http.get('../api/v1/panel/pais/panel/' + $scope.per_page + '/'+ $scope.search +'?page=' + $scope.page )
  ...
  $scope.updateHidden = function(id, value, name) {
    ...
    $scope.spinner = true;
    $http.post('../api/v1/panel/pais/update/' + id, httpdata)
    .success(function(response) {
